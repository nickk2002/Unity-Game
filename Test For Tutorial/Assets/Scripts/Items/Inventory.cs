...
public class Inventory : InventoryItem
{
    ...
    {
        enabledSlots = 0;
        slotPrefab = Resources.Load("Prefabs/UI/Slot") as GameObject;
        ...
        //GetComponent<Image>().color = inventoryMaterial.color;
    }
